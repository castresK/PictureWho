...
public class easyLevels implements ActionListener {
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon2 = new ImageIcon("img/ca.jpg");
        ImageIcon imageIcon3 = new ImageIcon("img/cannon.jpg");
        ImageIcon imageIcon4 = new ImageIcon("img/crydriver.jpg");

        Image image1 = imageIcon1.getImage().getScaledInstance(500, 300, Image.SCALE_SMOOTH);
        Image image2 = imageIcon2.getImage().getScaledInstance(500, 300, Image.SCALE_SMOOTH);
        Image image3 = imageIcon3.getImage().getScaledInstance(500, 300, Image.SCALE_SMOOTH);
        Image image4 = imageIcon4.getImage().getScaledInstance(500, 300, Image.SCALE_SMOOTH);
        ...
        imageLabel1.setBorder(BorderFactory.createLineBorder(new Color(borderColorRed, borderColorGreen, borderColorBlue), 2));
        imageLabel2.setBorder(BorderFactory.createLineBorder(new Color(borderColorRed, borderColorGreen, borderColorBlue), 2));
        imageLabel3.setBorder(BorderFactory.createLineBorder(new Color(borderColorRed, borderColorGreen, borderColorBlue), 2));
        imageLabel4.setBorder(BorderFactory.createLineBorder(new Color(borderColorRed, borderColorGreen, borderColorBlue), 2));
