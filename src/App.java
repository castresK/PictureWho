...
public class App extends JFrame {
    ...
    public App() {
        ...
        buttonPanel.setBorder(BorderFactory.createEmptyBorder(0, 430, 0, 430));
        ...
        playButton.setMargin(new Insets(10, 50, 10, 50)); 
        playButton.setBorder(BorderFactory.createLineBorder(Color.decode("#5E4580"), 2)); 
        ...
        settingsButton.setMargin(new Insets(10, 50, 10, 50)); 
        settingsButton.setBorder(BorderFactory.createLineBorder(Color.decode("#5E4580"), 2)); 
        ...
        exitButton.setMargin(new Insets(10, 50, 10, 50));
        exitButton.setBorder(BorderFactory.createLineBorder(Color.decode("#5E4580"), 2));
    ...
    private void openDifficultyWindow() {
        ...
        easyButton.setMargin(new Insets(10, 50, 10, 50)); 
        easyButton.setBorder(BorderFactory.createLineBorder(Color.decode("#5E4580"), 2)); 
        ...
        moderateButton.setMargin(new Insets(10, 50, 10, 50)); 
        moderateButton.setBorder(BorderFactory.createLineBorder(Color.decode("#5E4580"), 2)); 

        JButton hardButton = new JButton("Hard");
        hardButton.setFont(new Font("segoe ui black", Font.BOLD, 23));
        hardButton.setForeground(Color.decode("#5E4580"));
        hardButton.setBackground(Color.WHITE);
        hardButton.setMargin(new Insets(10, 50, 10, 50)); 
        hardButton.setBorder(BorderFactory.createLineBorder(Color.decode("#5E4580"), 2)); 
    ...
    private Font loadFont(String path, int style, float size) {
        try {
            File file = new File("picturewhoLevels-main/src/PaytoneOne-Regular.ttf");
