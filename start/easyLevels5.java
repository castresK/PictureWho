...
// Hint system variables and methods for providing hints to players
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon1 = new ImageIcon("Picture Who/project/main/img/5.png");
    ...
    private void addBackPanel(JFrame gameFrame) {
        ...
        Image backImage = backIcon.getImage().getScaledInstance(180, 80, Image.SCALE_SMOOTH);    
    ...
    private void addHintPanel(JFrame gameFrame) {
        ...
        Image hintImage = hintIcon.getImage().getScaledInstance(300, 250, Image.SCALE_SMOOTH);
