...
public class easyLevels implements ActionListener {
    ...
    private void openGameWindow() {
        ...
        ImageIcon imageIcon1 = new ImageIcon("Picture Who/project/main/img/1.png");
        ...
        answerPanel.setBorder(BorderFactory.createEmptyBorder(20, 780, 10, 780));
    ...
    private void addHintPanel(JFrame gameFrame) {
        ...
        Image hintImage = hintIcon.getImage().getScaledInstance(500, 250, Image.SCALE_SMOOTH);
